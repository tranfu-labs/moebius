...
export const en = {
  ...
  "dialog.install.cancel": "Cancel",
  "dialog.install.restart": "Restart and install",
  "dialog.install.title": "Install Moebius update",
  "dialog.install.message": "Version {version} is ready. Moebius will close, install the update, and reopen.",
  "dialog.install.stay": "Keep working",
  "dialog.install.stopAndRestart": "Stop tasks and restart to install",
