...
export const CLAUDE_TUI_TRANSCRIPT_SETTLE_TIMEOUT_MS = 60_000;
export const CLAUDE_TUI_TRANSCRIPT_RETRY_INTERVAL_MS = 100;
export const CLAUDE_TUI_MULTILINE_SUBMIT_SETTLE_MS = 75;
export const CLAUDE_TUI_MULTILINE_SUBMIT_FALLBACK_MS = 500;
export const CLAUDE_TUI_NATIVE_PROMPT_STALL_MS = parseOptionalPositiveInteger(
  process.env.MOEBIUS_CLAUDE_TUI_NATIVE_PROMPT_STALL_MS,
) ?? 10_000;
...
export const GITHUB_TEAM_GH_TIMEOUT_MS = 15_000;
export const GITHUB_TEAM_GH_MAX_OUTPUT_BYTES = 16 * 1024 * 1024;
...
export const LOCAL_CONSOLE_ATTACHMENT_PREVIEW_LARGE_MAX_BYTES = 8 * 1024 * 1024;
export const LOCAL_CONSOLE_ATTACHMENT_PREVIEW_LARGE_MAX_EDGE = 2048;
export const LOCAL_CONSOLE_AGENT_IMAGE_SOURCE_MAX_BYTES = 32 * 1024 * 1024;
