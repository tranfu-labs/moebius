  ...
  return (
    <span className="grid min-w-0 flex-1 gap-1 py-0.5 text-left">
      <span className="flex min-w-0 items-center gap-2">
        <span className="truncate font-normal text-ink">{team.label}</span>
        {team.ownership ? (
          <span className="rounded-full border border-line px-1.5 py-0.5 text-meta font-normal text-sub">
      ...
      <span className="flex flex-wrap items-center gap-1 text-meta font-normal text-sub">
      ...
      <span className="flex flex-wrap items-center gap-1.5">
        {visibleMembers.map((member) => (
          <span key={member.slug} className="inline-flex items-center gap-1 text-meta font-normal text-sub">
        ...
        {hiddenCount > 0 ? (
          <button
            type="button"
            className="rounded-full border border-line px-1.5 py-0.5 text-meta font-normal text-sub hover:bg-hover hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
          ...
          <button
            type="button"
            className="text-meta font-normal text-sub hover:text-ink"
