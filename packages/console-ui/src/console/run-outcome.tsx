...
export function RunOutcome({
  ...
  }, [executionRegistryState, overrideProfile]);
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-2.5">
        ...
        {status !== "retry-exhausted" && onRetry !== undefined ? (
          <Button
            type="button"
            variant="outline"
            size="sm"
        ...
        {onOverrideAndRetry !== undefined ? (
          <Button type="button" variant="outline" size="sm" onClick={() => setOverrideOpen((open) => !open)}>
      ...
      {overrideOpen && onOverrideAndRetry !== undefined ? (
          ...
          <div className="flex justify-end sm:col-span-3">
            <Button
              ...
              onClick={() => {
                ...
                const callback = overrideCallbackRef.current;
            ...
            >
              {t("console.runOutcome.confirmOverrideRerun")}
            </Button>
          </div>
