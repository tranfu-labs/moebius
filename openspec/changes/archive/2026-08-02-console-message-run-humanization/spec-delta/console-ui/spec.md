# console-ui spec delta：console-message-run-humanization

说明：本文件保留为项目级 `spec-delta/` 路径；OpenSpec CLI 可验证版本同步写在 `openspec/changes/console-message-run-humanization/specs/console-ui/spec.md`。两者语义保持一致。
