...
The local console MUST satisfy the following sidebar-metadata persistence contract.
...
The local console MUST satisfy the following read-state mutation contract.
...
The local console MUST satisfy the following manual-unread lifecycle contract.
...
The local console MUST satisfy the following pin-and-title mutation contract.
